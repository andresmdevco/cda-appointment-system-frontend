...
const Home = () => {
    ...
    const handleReservar = async () => {
        ...
        if (!user_id) {
            alert(
                "No hay usuario identificado. Por favor inicia sesión nuevamente.",
            );
            return;
        }
        try {
        ...
        <div className="home-page">
            ...
            <div className="home-left">
                ...
                <div className="home-section">
                    <h3>Misión</h3>
                    <p>
                        En CDA Pradera nos dedicamos a la inspección
                        técnico-mecánica de vehículos particulares, garantizando
                        que tu vehículo cumpla todas las normas de seguridad y
                        circulación.
                    </p>
                </div>
                <div className="home-section">
                    ...
                    <ul className="home-features">
                        ...
                        <li>
                            <FaShieldAlt />
                            <span>Inspección exhaustiva y certificada</span>
                        </li>
                        <li>
                            <MdCalendarToday />
            ...
            <div className="home-right">
                <div className="home-right-inner">
                    ...
                    <div className="home-right-header">
                        ...
                        <p className="home-right-subtitle">
                    ...
                    <div className="home-tabs">
                        <button
                            ...
                            onClick={() => tab === "resumen" && setTab("info")}
                        >
                            Información de cita
                        </button>
                        <button
